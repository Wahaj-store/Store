...
export default function AdminManager() {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(false); // حالة التحكم في فتح وإغلاق القائمة على الموبايل
    ...
    <div className="space-y-4" dir="rtl">
      ...
      <div className="flex items-center justify-between lg:hidden bg-muted/10 border border-border/40 rounded-2xl p-3 shadow-xs">
        ...
        >
          ...
          <span>{sidebarOpen ? 'إغلاق القائمة' : 'قسام لوحة التحكم'}</span>
        </button>
      ...
      <div className="grid gap-8 lg:grid-cols-[280px_1fr] items-start relative">
        ...
        `}>
          ...
          <div className="flex items-center justify-between lg:hidden pb-3 border-b border-border/30">
            ...
            <button onClick={() => setSidebarOpen(false)} className="p-1.5 rounded-xl bg-muted/20 text-muted-foreground hover:text-foreground">
              <X size={18} />
            </button>
          </div>
