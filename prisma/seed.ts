...
async function main(){
 ...
 const cats=[['خواتم','rings'],['سلاسل','necklaces'],['أساور','bracelets'],['انسيالات','anklets'],['حلقان','earrings'],['أطقم','sets'],['هدايا','gifts'],['إكسسوارات','accessories']];
 for(const [name,slug] of cats) await prisma.category.upsert({where:{slug},update:{name},create:{name,slug,active:true}});
 const category=await prisma.category.findFirstOrThrow();
 const products=[['سلسلة وهج الذهبية','wahaj-golden-necklace',399,599,'1515562141207-7a88fb7ce338'],['خاتم اللمعة','glow-ring',474,679,'1605100804763-247f67b3557e'],['سوار كلاسيك','classic-bracelet',549,799,'1611652022419-a9419f74343d'],['انسيال ناعم','soft-anklet',624,899,'1573408301185-9146fe634ad0']];
 ...
 const flags=[['wishlist','المفضلة'],['dark_mode','الوضع الداكن'],['quick_view','العرض السريع'],['recently_viewed','شوهد مؤخراً'],['cart_drawer','سلة جانبية'],['gift_wrap','تغليف الهدايا'],['popup','النوافذ المنبثقة'],['smart_recommendations','التوصيات الذكية'],['newsletter','النشرة البريدية'],['abandoned_cart','السلات المتروكة']]; for(const [key,description] of flags) await prisma.featureFlag.upsert({where:{key},update:{description},create:{key,description,enabled:key!=='gift_wrap'&&key!=='abandoned_cart'}});
