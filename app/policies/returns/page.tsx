...
لتسهيل خدمة العملاء، يرجى التواصل معنا مباشرة عبر قنوات الدعم الخاصة بالمتجر مع إرفاق رقم الطلب وصورة واضحة للمنتج عند وجود أي ملاحظة.
  ...
  return (
    <main className="min-h-screen py-16 px-4 bg-[#0a0a0a] text-white" dir="rtl">
      <div className="container max-w-4xl mx-auto space-y-12">
        ...
        {/* صندوق المحتوى الداكن بالكامل */}
        <div className="bg-[#121212] border border-white/10 rounded-2xl p-6 md:p-10 shadow-2xl space-y-6">
          <div className="whitespace-pre-wrap font-sans text-neutral-200 text-base md:text-lg leading-loose">
            {content}
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 pt-2">
          <div className="bg-[#121212] border border-white/10 p-6 rounded-xl text-center space-y-3 shadow-md hover:border-[var(--gold)]/50 transition">
            <ShieldCheck size={28} className="mx-auto text-[var(--gold)]" />
            <h3 className="font-semibold text-base text-white">ضمان الجودة</h3>
            <p className="text-neutral-400 text-xs md:text-sm leading-relaxed">منتجات أصلية ومفحوصة بدقة وعناية فائقة.</p>
          </div>

          <div className="bg-[#121212] border border-white/10 p-6 rounded-xl text-center space-y-3 shadow-md hover:border-[var(--gold)]/50 transition">
            <Truck size={28} className="mx-auto text-[var(--gold)]" />
            <h3 className="font-semibold text-base text-white">إجراءات سريعة</h3>
            <p className="text-neutral-400 text-xs md:text-sm leading-relaxed">معالجة الطلبات في أسرع وقت ممكن.</p>
          </div>

          <div className="bg-[#121212] border border-white/10 p-6 rounded-xl text-center space-y-3 shadow-md hover:border-[var(--gold)]/50 transition">
            <HelpCircle size={28} className="mx-auto text-[var(--gold)]" />
            <h3 className="font-semibold text-base text-white">دعم العملاء</h3>
            <p className="text-neutral-400 text-xs md:text-sm leading-relaxed">فريق دعم جاهز لمساعدتك دائماً.</p>
          </div>
        </div>
